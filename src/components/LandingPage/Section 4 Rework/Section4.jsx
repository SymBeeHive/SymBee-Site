          ...
          <div className="cards-pq">
            ...
            <div className="beneficio-mutuo">
              ...
              <p>
                ...
                <span className="bm-symbee"> positivo</span> na vida
                profissional e pessoal dos usuários.
              </p>
            </div>
            <div className="beneficio-mutuo">
              ...
              <p>
                Incentivamos a disputa{" "}
                <span className="bm-symbee">saúdavel</span> entre nossos
                usuários por meio de nosso ranking e reputação.
              </p>
            </div>
          </div>
        </div>
